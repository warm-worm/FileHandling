...
thousands_pattern = r'\d{1,3}(?:,\d{3})*' #non-capturing group that matches zero or more occurrences of a comma followed by three digits
thousand_numbers = re.findall(thousands_pattern, text)

name_pattern = r'\b(?!March|June|December|Her|They|In)[A-Z][a-z]+\b'
